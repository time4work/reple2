...
let Tree = class{
    ...
    constructor(start_key ,tmpl_pack, lib_pack){
        ...
        console.log('_Tree__________');
        console.log(start_key);
        console.log('_Tree_start_key_________');
        console.log(tmpl_pack);
        console.log('_Tree_tmpl_pack_________');
        console.log(lib_pack);
        console.log('_Tree_lib_pack_________');
    ...
    parseTmplObj(json){
        console.log(json);
        console.log("s_________json");
        var tmpl_arr= json.map((item)=>{
            var obj = {};
            obj[item['keyword']] = [];
            return obj;
        });
        console.log(tmpl_arr);
        console.log("__________tmpl_arr");
        var tmpl = {};
